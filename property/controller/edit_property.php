...
$property->updateProperty($status,$prop_id, $name, $address1, $address2, $city, $province, $extent,$type, $unit_price, $description);
header("location:../../admin/view/manage_properties.php?propId=".$prop_id);
?>