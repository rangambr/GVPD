...
if ($_FILES["uploadedfile1"]["error"] == 0 ) {
    ...
    if(($_FILES["uploadedfile1"]["size"] / 1024) < 1024 && ($file_type == 'image/png' || $file_type == 'image/gif' || $file_type == 'image/jpeg' || $file_type == 'image/gif') ){
...
if ($_FILES["uploadedfile2"]["error"] == 0 ) {
   ...
   if(($_FILES["uploadedfile2"]["size"] / 1024) < 1024 && ($file_type == 'image/png' || $file_type == 'image/gif' || $file_type == 'image/jpeg' || $file_type == 'image/gif')){
...
if ($_FILES["uploadedfile3"]["error"] == 0) {
   $file_type = $_FILES["uploadedfile3"]["type"];
    if(($_FILES["uploadedfile3"]["size"] / 1024) < 1024 && ($file_type == 'image/png' || $file_type == 'image/gif' || $file_type == 'image/jpeg' || $file_type == 'image/gif')){
