...
<div class="content">
  ...
  <tr>
    ...
    <td>
    	...
    	<h3> <span style="font-style: normal; color: #ff0000; font-size: large;">$1,695,000</span></h3>
    	<span style="font-style: normal"><br/>
        <span style="font-size: 14px">Northwood House, 8b, Stumperlowe Hall Road, Fulwood
</p>
        </span></span>
