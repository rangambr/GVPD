            ...
            <div class="CSSTableGenerator" >
                <table class="user_table">
                    ...
                    while ($agr = mysql_fetch_array($all_agrs)) {
                        ...
                        echo "<td class='ac_link'><a  href='edit_agreement .php?agr_id=" . $agr['id'] . "'><span class='create_link' title='Edit Agreement'></span></a>";
                        echo " | <a  href='view_agreement .php?agr_id=" . $agr['id'] . "'><span class='view_link' title='View Agreement'></span></a>";
                        echo " | <a  href='print_agreement.php?agr_id=" . $agr['id'] . "'><span class='print_link' title='Print Agreement'></span></a>";
                        echo " | <a onClick=\"return confirm('Are you sure?')\" href='../controller/delete_agreement.php?agr_id=" . $agr['id'] . "'><span class='delete_link' title='Delete Agreement'></span></a></td><tr>";
                    }
                    ?> 
                </table>
            </div>
