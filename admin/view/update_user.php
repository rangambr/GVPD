    	...
    	<table width="500px" bgcolor="#FCF4E9" cellpadding="5px">
        	<tr>
            	<td colspan="2" bgcolor="#9fa393">
                	<div style="color: #FFFFFF; font-style: normal; font-size: large; height:20px;">Update User</div>
                </td>
            </tr>
            <tr>
            	<td style="font-weight: normal" align="center">User ID:</td>
                <td><input type="text" name="txt_usrid"/></td>
            </tr>
        	<tr>
            ...
            <tr>
            	<td colspan="2" align="center"><input type="submit" value="Edit User"/></td>
            </tr>
        </table>
        </form>
    </div>
