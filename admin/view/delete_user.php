        ...
        <div class="content">
            ...
            <div class="right_box">
                    ...
                    <table width="500px" bgcolor="#FCF4E9" cellpadding="5px">
                        <tr>
                            <td colspan="3" bgcolor="#9fa393">
                                <div style="color: #FFFFFF; font-style: normal; font-size: large; height:20px;">Delete  User</div>
                            </td>
                        </tr>
                        <tr>
                        	 <td>&nbsp;</td>
                        ...
                        <?php
                            ...
                            $admin = new Admin();
                            $delAdmins = $admin->deleteAdmin();

                            while ($row = mysql_fetch_array($delAdmins)) {
                    ...
                    <tr>
                    	<td colspan="3" align="center"><input type="submit" name="delete" value="Delete"/></td>
                    </tr>
                </table>
