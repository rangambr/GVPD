...
<table align="center" border="0" width="70%">
    <tr>
    	<td align="center"><input type="submit" name="submit" value="Manage Users" class="myButton"/></td>
        <td align="center"><input type="submit" name="submit" value="Search Payments" class="myButton"/></td>
    </tr>
    <tr>
    	<td align="center"><input type="submit" name="submit" value="Manage Property" class="myButton"/></td>
        <td align="center"><input type="submit" name="submit" value="Search Users" class="myButton"/></td>
    </tr>
    <tr>
    	<td align="center"><input type="submit" name="submit" value="Generate Reports" class="myButton"/></td>
        <td align="center"><input type="submit" name="submit" value="Feedback" class="myButton"/></td>
    </tr>
    <tr>
    	<td align="center">&nbsp;</td>
        <td align="center">&nbsp;</td>
