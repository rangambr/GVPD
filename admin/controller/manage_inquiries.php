...
echo '<tr><td>Name</td><td>Subject</td><td>Status</td><td>Action</td></tr>';
while ($inqu = mysql_fetch_array($all_inc)) {
    ...
    if($inqu['status'] != 'Closed'){
        echo " | <a onClick=\"return confirm('Are you sure you want to close?')\" href='../controller/close_inquiry.php?inqId=" . $inqu['inquiry_id'] . "'><span class='close_link' title='Close inquiry'></span></a>";
