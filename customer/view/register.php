    ...
    <head>
        ...
        <script>
            ...
            function validate() {
                ...
                if (!checkPassword($("#txtpass").val())) {
                    alert('Please enter at least six characters with one number, one lowercase and one uppercase letter as your password.');
                    return false;
                }
                if ($("#txtpass").val() != $("#txtpass2").val()) {
                    alert('Please re-enter matching passwords.');
                    return false;
                }
                return true;
            }
...
=======
    ...
    <body  bgcolor="#EAF3CF">
        ...
        <div class="content">
            <form name="register" method="post" action="../controller/register.php" onsubmit="return validate();">
                <table align="center" width="500" style="border:1px groove #93AE13;border-collapse: collapse;">
                    <tr bgcolor="#005825">
                        <td colspan="2" align="center" bgcolor="#335523"><h1 style="color: #FFFFFF">User Registration</h1></td>
                    </tr>
                    <tr>
                        <th align="left">First Name :</th>
                        <td><input name="txtfname" type="text" id="txtfname" placeholder="Please type your first  name here" size="20" class="inputs" /></td>
